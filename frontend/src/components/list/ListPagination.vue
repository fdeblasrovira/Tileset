...
<template>
  <nav class="flex justify-center" aria-label="Pagination">
    <ul class="inline-flex mt-8 cursor-pointer">
      <li>
        <a @click="previousOffset()"
          class="py-2 px-3 ml-0 leading-tight text-gray-500 bg-tileset-grey-1 rounded-l-lg border border-gray-300 hover:bg-tileset-grey-2 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Previous</a>
      </li>
      ...
      <li>
        <a @click="nextOffset()"
          class="py-2 px-3 leading-tight text-gray-500 bg-tileset-grey-1 rounded-r-lg border border-gray-300 hover:bg-tileset-grey-2 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Next</a>
      </li>
    </ul>
  </nav>
</template>
