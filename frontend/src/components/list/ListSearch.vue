...
<template>
  <div class="flex items-center mb-3">
    ...
    <div class="relative w-full">
      ...
      <input @keyup.enter="search" v-model="searchConditions.textSearch" type="text" id="simple-search"
    ...
    <div @click="sortVisible = !sortVisible" class="relative inline-block text-left">
      <div class="ml-2">
        <button type="button"
          ...
          <p v-bind:class="sortByValue > 0 ? 'text-tileset-black' : 'text-tileset-grey-5'
    ...
    <button @click="search"
      ...
      <svg class="w-5 h-5 text-tileset-full-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg">
