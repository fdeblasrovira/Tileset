...
<template>
  <div class="border rounded-md border-tileset-grey-2 space-y-3 px-4 py-5 sm:p-6">
    ...
    <div v-if="questions.length <= 0" class="w-full h-10 text-center items-center m-auto font-light italic">
    ...
    <template v-for="(question, index) in questions" :key="question.id">
      <div class="border rounded-md border-tileset-grey-2 space-y-6 px-4 py-5 sm:p-6">
        ...
        <div class="flex justify-between">
          <FullButton @click="displayQuestionDeleteModal(true, index)" text="Delete" color="bg-tileset-red"
          ...
          <FullButton @click="displayQuestionEditModal(true, index)" text="Edit" color="bg-tileset-blue"
    ...
    <div class="flex">
      ...
      <FullButton @click="addQuestion(addQuestionSelectValue)" text="Add" color="bg-tileset-blue"
  ...
  <Modal :open="showQuestionDeleteModal" title="Delete question"
    ...
    <template #buttons>
      <div class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
        ...
        <button @click="showQuestionDeleteModal = false" type="button"
  ...
  <Modal :open="showQuestionEditModal" title="Edit question" description="Edit the question's parameters"
          ...
          <div class="flex px-2 w-full justify-center">
            <button @click="addOption()" type="button"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3.5"
                stroke="currentColor" class="w-6 h-6 pt-1 ml-1 stroke-tileset-white">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6" />
              </svg>
            </button>
          </div>
    ...
    <template #buttons>
      ...
      <div class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
        ...
        <button @click="showQuestionEditModal = false" type="button"
